...
```bash
go get github.com/risor-io/risor@v1.5.2
```
...
| -------- | ------------------------------------------ | ------------------------------------------------------------ |
| aws      | [modules/aws](./modules/aws)               | `go get github.com/risor-io/risor/modules/aws@v1.5.2`        |
| cli      | [modules/cli](./modules/cli)               | `go get github.com/risor-io/risor/modules/cli@v1.5.2`        |
| image    | [modules/image](./modules/image)           | `go get github.com/risor-io/risor/modules/image@v1.5.2`      |
| jmespath | [modules/jmespath](./modules/jmespath)     | `go get github.com/risor-io/risor/modules/jmespath@v1.5.2`   |
| k8s      | [modules/kubernetes](./modules/kubernetes) | `go get github.com/risor-io/risor/modules/kubernetes@v1.5.2` |
| pgx      | [modules/pgx](./modules/pgx)               | `go get github.com/risor-io/risor/modules/pgx@v1.5.2`        |
| s3fs     | [os/s3fs](./os/s3fs)                       | `go get github.com/risor-io/risor/os/s3fs@v1.5.2`            |
| sql      | [modules/sql](./modules/sql)               | `go get github.com/risor-io/risor/modules/sql@v1.5.2`        |
| template | [modules/template](./modules/template)     | `go get github.com/risor-io/risor/modules/template@v1.5.2`   |
| uuid     | [modules/uuid](./modules/uuid)             | `go get github.com/risor-io/risor/modules/uuid@v1.5.2`       |
| vault    | [modules/vault](./modules/vault)           | `go get github.com/risor-io/risor/modules/vault@v1.5.2`      |
