...
import (
	...
	modMath "github.com/cloudcmds/tamarin/core/modules/math"
	modRand "github.com/cloudcmds/tamarin/core/modules/rand"
	modStrconv "github.com/cloudcmds/tamarin/core/modules/strconv"
	modStrings "github.com/cloudcmds/tamarin/core/modules/strings"
	modTime "github.com/cloudcmds/tamarin/core/modules/time"
	modUuid "github.com/cloudcmds/tamarin/core/modules/uuid"
...
// expression in the main source code, which may be object.Nil
...
func Execute(ctx context.Context, opts Opts) (result object.Object, err error) {
	...
	// Tamarin object, so defaulting to object.Nil may make sense
	if result == nil {
